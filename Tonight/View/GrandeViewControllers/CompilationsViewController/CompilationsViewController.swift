//
//  CompilationsViewControllerCollectionViewController.swift
//  Tonight
//
...
class CompilationsViewController: UICollectionViewController {
    ...
    //MARK: - Layout Compilations VC's collection view
